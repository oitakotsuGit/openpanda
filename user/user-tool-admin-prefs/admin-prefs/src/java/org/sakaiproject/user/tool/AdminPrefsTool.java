/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/user/branches/sakai-10.x/user-tool-admin-prefs/admin-prefs/src/java/org/sakaiproject/user/tool/AdminPrefsTool.java $
